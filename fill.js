...
<body>
  ...
  <nav id="navbar">
    ...
    <a href="javascript:void(0)" onclick="toggleModal()" class="btn-quote-nav">Inquiry</a>
  </nav>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <div class="hero-btns">
        <button onclick="toggleModal()" class="btn-primary">Get Custom Quote</button>
      </div>
    </div>
  </section>
    ...
    <div class="product-grid">
      ...
      <div class="product-card">
        ...
        <div class="product-info">
          ...
          <a href="javascript:void(0)" onclick="trackInquiry('Rigid Boxes'); toggleModal()" class="product-cta">Customize Deal →</a>
        </div>
      </div>
      <!-- 2. Cake Boxes -->
      <div class="product-card">
        ...
        <div class="product-info">
          ...
          <a href="javascript:void(0)" onclick="trackInquiry('Cake Boxes'); toggleModal()" class="product-cta">Customize Deal →</a>
        </div>
      </div>
      <!-- 3. Cardboard Bags -->
      <div class="product-card">
