...
<head>
    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .form-section h2 {{ font-family: 'Playfair Display', serif; font-size: 32px; color: var(--gold); margin-bottom: 40px; text-align: center; }}
        .luxo-form {{
...
<body>
    <nav>
        <a href="index" class="logo">
            <img src="https://sc02.alicdn.com/kf/A94ddad755cf74f0d93ee51ab0229ac3ac.png" alt="Logo" style="height: 40px; width: auto; vertical-align: middle;">
            <span style="margin-left: 10px; vertical-align: middle;">iColorPack</span>
        </a>
        <ul class="nav-links">
...
SECTORS = [
    ...
    },
    {
        ...
        "img4": "https://sc02.alicdn.com/kf/Aae1fd2bd6e7c41c6888110cd1889faffX.png",
